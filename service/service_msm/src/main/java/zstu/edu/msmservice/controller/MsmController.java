...
public class MsmController {
    ...
    public R code(@PathVariable String phone) {
        ...
        System.out.println("redis code:"+code);
        ...
        if (isSend) {
            ...
            System.out.println("redis code:"+redisTemplate.opsForValue().get(phone));
            return R.ok().data("code", code);
        } else {
...
//    //发送邮箱验证码的方法
//    @GetMapping("sendmail/{mailAdress}")
...
//        code = RandomUtil.getSixBitRandom();
//        //调用service发短信息的方法
//        boolean isSend = msmService.sendMail(mailAdress,code);
//        if (isSend) {
